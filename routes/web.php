...
Route::get('/view_product',[ProductsController::class,'view_products'])->name('products.view');
Route::post("/add_product",[ProductsController::class,"add_product"])->name('products.add');
